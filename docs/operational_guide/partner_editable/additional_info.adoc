...
... Add all attrubutes to be used by Immuta by clicking *Add Another Attribute* and entering the attribute information for each attribute. Be sure to click *Create: <attribute name>* in the dropdown for Immuta Attribute Key field after you enter the attribute name for any new attributes being imported
